...
type ChopusUIMessage = UIMessage<ChatMessageMetadata, never, InferUITools<ToolContracts>>;

const submitSchema = z.object({
  id: z.string(),
  messages: z
    .array(
      z.custom<ChopusUIMessage>((value) => {
...
function hasPendingToolCalls(message: ChopusUIMessage) {
...
const app = new Hono<AuthenticatedEnv>()
  .post(
    ...
    async (c) => {
      ...
      return result.toUIMessageStreamResponse<ChopusUIMessage>({
